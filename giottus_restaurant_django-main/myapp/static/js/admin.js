let apiUrlViewlist = "http://localhost:9000/api/view_item_list"
let apiUrlCartData = "http://localhost:9000/api/get_cart_data"
...
fetch("http://localhost:9000/api/edit_item", { 
  method: "POST",
  body: bodyContent,
...
fetch("http://localhost:9000/api/create_item", { 
  method: "POST",
  body: bodyContent,
}).then(function(response) {
  return response.text();
